package tecsup.com.negocio;

import java.util.Collection;

import tecsup.com.dao.CategoriaDAO;
...
public class GestionCategorias {
	...
	public Categoria insertar(String nombre, String descripcion) throws DAOExcepcion {
		CategoriaDAO dao = new CategoriaDAO();
	...
	public Categoria actualizar(int idCategoria, String nombre, String descripcion) throws DAOExcepcion {
		CategoriaDAO dao = new CategoriaDAO();
		Categoria vo = new Categoria();
